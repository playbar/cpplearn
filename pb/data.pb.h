...
class PhoneNumber : public ::google::protobuf::Message {
 public:
  ...
  inline ::tutorial::PhoneType type() const;
  inline void set_type(::tutorial::PhoneType value);
...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline const ::tutorial::PhoneNumber& phones(int index) const;
  inline ::tutorial::PhoneNumber* mutable_phones(int index);
  inline ::tutorial::PhoneNumber* add_phones();
...
inline void PhoneNumber::set_type(::tutorial::PhoneType value) {
  assert(::tutorial::PhoneType_IsValid(value));
  set_has_type();
  type_ = value;
}
