...
//RetType myFunc(const Type1& t1, const Type2& t2)
//{
//	return t1 + t2;
//}
...
//template<typename Type1, typename Type2>
//decltype(t1+t2) myFunc(const Type1& t1, const Type2& t2)
//{
//	return t1 + t2;
//}

// Using the alternative function syntax, the following will compile and work
template<typename Type1, typename Type2>
...
// C++14: using automatic function return type deduction, the following will compile and work
//template<typename Type1, typename Type2>
