...
namespace ProCpp {
	...
	template <typename Key, typename T, typename Compare, typename Hash>
	hash_map<Key, T, Compare, Hash>& hash_map<Key, T, Compare, Hash>::operator=(const hash_map<Key, T, Compare, Hash>& rhs)
	{
		if (&rhs == this) {
			return *this;
		}
	...
	template <typename Key, typename T, typename Compare, typename Hash>
	hash_map<Key, T, Compare, Hash>& hash_map<Key, T, Compare, Hash>::operator=(hash_map<Key, T, Compare, Hash>&& rhs) noexcept
	{
		// Just move each data member.
