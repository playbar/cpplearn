...
namespace ProCpp {
	...
	template <typename Key, typename T, typename Compare, typename Hash>
	void hash_map<Key, T, Compare, Hash>::CopyFrom(const hash_map_type& src)
	{
		mComp = src.mComp;
		mHash = src.mHash;
	...
	template <typename Key, typename T, typename Compare, typename Hash>
	hash_map<Key, T, Compare, Hash>::hash_map(const hash_map_type& src)
	{
		CopyFrom(src);
	}

	template <typename Key, typename T, typename Compare, typename Hash>
	hash_map<Key, T, Compare, Hash>::hash_map(hash_map_type&& src) noexcept
	{
	...
	template <typename Key, typename T, typename Compare, typename Hash>
	hash_map<Key, T, Compare, Hash>& hash_map<Key, T, Compare, Hash>::operator=(const hash_map_type& rhs)
	{
		if (&rhs == this) {
			return *this;
		}
	...
	template <typename Key, typename T, typename Compare, typename Hash>
	hash_map<Key, T, Compare, Hash>& hash_map<Key, T, Compare, Hash>::operator=(hash_map_type&& rhs) noexcept
	{
		// Just move each data member.
